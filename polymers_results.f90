module polymers_results
	...
	public  WriteAverageDistanceToFile, WriteAverageRadiusGyrationToFile, WriteTestVector, WriteTestVector2, WritePolymer
...
contains
	...
	subroutine WriteTestVector2(vector, n, m)
		integer, intent(in) :: n,m
		integer :: i, j
		real(8), intent(in), dimension(n,m) :: vector


		open (unit=5,file="weightvector.data",action="write")
